...
Then, The following variables can be set:
...
- (OPTIONAL) `DeveloperModeEnabled` - Setting this `True` will allow you to access the Developer Tools Suite in the [Access Startup Menu](#access-startup). DO NOT USE THE SUITE IF YOU ARE NOT A DEVELOPER. MISUSE OF THE SUITE MAY RENDER YOUR COPY OF ACCESS UNUSABLE.
